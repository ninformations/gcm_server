...
public class CcsClient {
    ...
    public void sendBroadcast(Map<String, String> payload, String collapseKey,
            long timeToLive, Boolean delayWhileIdle, List<String> recipients) throws SmackException.NotConnectedException {
     ...
     */
    public void handleIncomingDataMessage(CcsMessage msg) throws SmackException.NotConnectedException {
    ...
    private void handleMessage(Map<String, Object> jsonMap) throws SmackException.NotConnectedException {
